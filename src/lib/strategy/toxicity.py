...
class Toxicity(Strategy):
    ...
    def evaluate(self, testcase:TestCase, conversation:Conversation) ->  float:
        ...
        """
        return self.toxicity_check(conversation.agent_response), OllamaConnect.get_reason(conversation.agent_response, " ".join(self.name.split("_")), self.toxicity_check(conversation.agent_response))